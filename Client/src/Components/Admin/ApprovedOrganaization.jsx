...
function ApprovedOrganaization() {
          ...
          <Table aria-label="hospital requests table">
            <TableHead>
              <TableRow className="table-head-row">
                ...
                <TableCell className="table-head-cell">Reg Number</TableCell>
                ...
                <TableCell className="table-head-cell">View Members</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {hospitalRequests.map((hospital) => (
                <TableRow key={hospital.id}>
                  ...
                  {/* <TableCell className='tableCell'>{hospital.operatingHours}</TableCell> */}
                  <TableCell className='tableCell'>{hospital.license}</TableCell>
                  <TableCell className="tableCell">
                    <Link to='/view-members'>View</Link>
                    {/* <Button 
                      variant="contained" 
                      color="success" 
                      size="small" 
...
export default ApprovedOrganaization;